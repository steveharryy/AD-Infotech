...
<head>
    ...
    <link rel="canonical" href="https://www.adinfotech.com/">
    <meta property="og:type" content="website">
    <meta property="og:title" content="AD Infotech | Premium IT Solutions, Hardware & Support">
    <meta property="og:description" content="A D Infotech provides premium computer hardware, desktop management services, AMC, networking, and IT support solutions in Nehru Place, New Delhi.">
    <meta property="og:image" content="https://www.adinfotech.com/assets/images/hero_it_infrastructure.webp">
    <meta property="og:url" content="https://www.adinfotech.com/">
    <meta property="og:site_name" content="AD Infotech">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="AD Infotech | Premium IT Solutions, Hardware & Support">
    <meta name="twitter:description" content="A D Infotech provides premium computer hardware, desktop management services, AMC, networking, and IT support solutions in Nehru Place, New Delhi.">
        ...
        <div class="container">
            ...
            <div class="about-grid">
                <div class="about-media-feature">
                    <img loading="lazy" decoding="async" src="<?php echo $base_path; ?>assets/images/about_workspace.webp" alt="AD Infotech technician repairing a laptop">
                ...
                <div class="deals-media">
                    <div class="deals-product-wrapper">
                        ...
                        <div class="deals-image-container">
                            <img loading="lazy" decoding="async" src="<?php echo $base_path; ?>assets/images/deals_printer.webp" alt="Original Laser Printers and Supplies" class="deals-img">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="glass-card products-banner">
                ...
                <div class="products-banner-media">
                    <img loading="lazy" decoding="async" src="<?php echo $base_path; ?>assets/images/products_retail.webp" alt="Computer Hardware Store Display" class="products-banner-img">
                </div>
            </div>
            ...
            <div class="products-grid">
                ...
                <div class="glass-card product-card" data-category="laptops">
                    <div class="product-card-header">
                        <img loading="lazy" decoding="async" src="<?php echo $base_path; ?>assets/images/product_laptop.webp" alt="HP Dell Lenovo Laptops" class="product-card-img">
                ...
                <div class="glass-card product-card" data-category="desktops">
                    <div class="product-card-header">
                        <img loading="lazy" decoding="async" src="<?php echo $base_path; ?>assets/images/product_desktop.webp" alt="Optiplex Prodesk Desktops" class="product-card-img">
                        <div class="product-card-overlay"></div>
                ...
                <div class="glass-card product-card" data-category="aio">
                    <div class="product-card-header">
                        <img loading="lazy" decoding="async" src="<?php echo $base_path; ?>assets/images/product_aio.webp" alt="All in One PCs" class="product-card-img">
                        <div class="product-card-overlay"></div>
                ...
                <div class="glass-card product-card" data-category="cartridges">
                    <div class="product-card-header">
                        <img loading="lazy" decoding="async" src="<?php echo $base_path; ?>assets/images/product_cartridge.webp" alt="Printer Cartridges" class="product-card-img">
                        <div class="product-card-overlay"></div>
                ...
                <div class="glass-card product-card" data-category="networking">
                    <div class="product-card-header">
                        <img loading="lazy" decoding="async" src="<?php echo $base_path; ?>assets/images/product_networking.webp" alt="Networking Cables" class="product-card-img">
                        <div class="product-card-overlay"></div>
                ...
                <div class="glass-card product-card" data-category="networking">
                    <div class="product-card-header">
                        <img loading="lazy" decoding="async" src="<?php echo $base_path; ?>assets/images/product_cctv.webp" alt="CCTV Cameras" class="product-card-img">
                        <div class="product-card-overlay"></div>
                        ...
                        <div class="brands-track" id="brands-track">
                            ...
                            <div class="brand-slide">
                                <div class="brand-card">
                                    <img loading="lazy" decoding="async" src="<?php echo $base_path; ?>assets/images/brands/cp-plus.svg" alt="CP Plus Logo" class="brand-logo-img">
                                </div>
                            </div>

                            <div class="brand-slide">
                                <div class="brand-card">
                                    <img loading="lazy" decoding="async" src="<?php echo $base_path; ?>assets/images/brands/hikvision.webp" alt="Hikvision Logo" class="brand-logo-img">
                                </div>
                            </div>

                            <div class="brand-slide">
                                <div class="brand-card">
                                    <img loading="lazy" decoding="async" src="<?php echo $base_path; ?>assets/images/brands/sonicwall.webp" alt="SonicWall Logo" class="brand-logo-img">
                                </div>
                            </div>

                            <div class="brand-slide">
                                <div class="brand-card">
                                    <img loading="lazy" decoding="async" src="<?php echo $base_path; ?>assets/images/brands/cyberoam.webp" alt="Cyberoam Logo" class="brand-logo-img">
                                </div>
                            </div>

                            <div class="brand-slide">
                                <div class="brand-card">
                                    <img loading="lazy" decoding="async" src="<?php echo $base_path; ?>assets/images/brands/samsung.webp" alt="Samsung Logo" class="brand-logo-img">
                                </div>
                            </div>

                            <div class="brand-slide">
                                <div class="brand-card">
                                    <img loading="lazy" decoding="async" src="<?php echo $base_path; ?>assets/images/brands/microsoft.svg" alt="Microsoft Logo" class="brand-logo-img">
                                </div>
                            </div>

                            <div class="brand-slide">
                                <div class="brand-card">
                                    <img loading="lazy" decoding="async" src="<?php echo $base_path; ?>assets/images/brands/cisco.svg" alt="Cisco Logo" class="brand-logo-img">
                                </div>
                            </div>

                            <div class="brand-slide">
                                <div class="brand-card">
                                    <img loading="lazy" decoding="async" src="<?php echo $base_path; ?>assets/images/brands/lenovo.webp" alt="Lenovo Logo" class="brand-logo-img">
                                </div>
                            </div>

                            <div class="brand-slide">
                                <div class="brand-card">
                                    <img loading="lazy" decoding="async" src="<?php echo $base_path; ?>assets/images/brands/acer.webp" alt="Acer Logo" class="brand-logo-img">
                                </div>
                            </div>

                            <div class="brand-slide">
                                <div class="brand-card">
                                    <img loading="lazy" decoding="async" src="<?php echo $base_path; ?>assets/images/brands/dell.webp" alt="Dell Logo" class="brand-logo-img">
                                </div>
                            </div>

                            <div class="brand-slide">
                                <div class="brand-card">
                                    <img loading="lazy" decoding="async" src="<?php echo $base_path; ?>assets/images/brands/hp.webp" alt="HP Logo" class="brand-logo-img">
                                </div>
                            </div>

                            <div class="brand-slide">
                                <div class="brand-card">
                                    <img loading="lazy" decoding="async" src="<?php echo $base_path; ?>assets/images/brands/dlink.webp" alt="D-Link Logo" class="brand-logo-img">
                                </div>
                            </div>

                            <div class="brand-slide">
                                <div class="brand-card">
                                    <img loading="lazy" decoding="async" src="<?php echo $base_path; ?>assets/images/brands/toshiba.webp" alt="Toshiba Logo" class="brand-logo-img">
                                </div>
                            </div>

                            <div class="brand-slide">
                                <div class="brand-card">
                                    <img loading="lazy" decoding="async" src="<?php echo $base_path; ?>assets/images/brands/mcafee.webp" alt="McAfee Logo" class="brand-logo-img">
                                </div>
                            </div>

                            <div class="brand-slide">
                                <div class="brand-card">
                                    <img loading="lazy" decoding="async" src="<?php echo $base_path; ?>assets/images/brands/lg.webp" alt="LG Logo" class="brand-logo-img">
                                </div>
                            </div>

                            <div class="brand-slide">
                                <div class="brand-card">
                                    <img loading="lazy" decoding="async" src="<?php echo $base_path; ?>assets/images/brands/intel.webp" alt="Intel Logo" class="brand-logo-img">
                                </div>
                            </div>

                            <div class="brand-slide">
                                <div class="brand-card">
                                    <img loading="lazy" decoding="async" src="<?php echo $base_path; ?>assets/images/brands/seagate.webp" alt="Seagate Logo" class="brand-logo-img">
                                </div>
                            </div>
                        </div>
                    </div>
