...
$base_path .= '/';
$products = [
    ['Laptops', 'Business and personal laptops from leading brands.', 'product_laptop.webp'],
    ['Desktops', 'Reliable desktop computers for offices, schools and homes.', 'product_desktop.webp'],
    ['All in Ones', 'Space-saving all-in-one PCs for modern workspaces.', 'product_aio.webp'],
    ['Networking', 'Switches, routers, cables and complete network equipment.', 'product_networking.webp'],
    ['Workstations', 'High-performance systems for demanding professional workloads.', 'product_desktop.webp'],
    ['Power Backups', 'UPS and power backup solutions to keep your work running.', 'product_networking.webp'],
    ['Printer Toner Cartridge', 'Genuine toner cartridges and printer consumables.', 'product_cartridge.webp'],
    ['Storage', 'Hard drives, SSDs and storage solutions for every need.', 'product_desktop.webp'],
    ['Firewall', 'Network security appliances to protect your business.', 'product_networking.webp'],
    ['Printers', 'Office and home printers from trusted brands.', 'product_cartridge.webp'],
    ['Laptops Bags', 'Protective laptop bags and carrying accessories.', 'product_laptop.webp'],
    ['Servers', 'Scalable server hardware for growing organizations.', 'product_desktop.webp'],
    ['CCTV', 'Smart surveillance cameras and security systems.', 'product_cctv.webp'],
    ['Scanners', 'Fast, reliable document and image scanning solutions.', 'product_aio.webp'],
    ['Laptop Battery', 'Replacement batteries for dependable laptop power.', 'product_laptop.webp'],
];
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <link rel="canonical" href="https://www.adinfotech.com/products.php">
    <meta property="og:type" content="website">
    <meta property="og:title" content="Computer Hardware & Peripherals Product Catalog | AD Infotech">
    <meta property="og:description" content="Browse enterprise laptops, desktops, workstations, printers, CCTV cameras, and networking equipment.">
    <meta property="og:image" content="https://www.adinfotech.com/assets/images/hero_it_infrastructure.webp">
    <meta property="og:url" content="https://www.adinfotech.com/products.php">
    <meta property="og:site_name" content="AD Infotech">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Computer Hardware & Peripherals Product Catalog | AD Infotech">
    <meta name="twitter:description" content="Browse enterprise laptops, desktops, workstations, printers, CCTV cameras, and networking equipment.">
...
<body>
    ...
    <header class="sticky-header-container"><nav class="nav-bar scrolled">
        <a href="<?php echo $base_path; ?>index.php#home" class="nav-brand" aria-label="AD Infotech Home"><img loading="lazy" decoding="async" src="<?php echo $base_path; ?>assets/images/logo-dark.webp" alt="AD Infotech Logo" class="nav-logo-img logo-dark"><img loading="lazy" decoding="async" src="<?php echo $base_path; ?>assets/images/logo-light.webp" alt="AD Infotech Logo" class="nav-logo-img logo-light"></a>
