...
$products = [
    ...
    ['Workstations', 'High-performance systems for demanding professional workloads.', 'product_workstation.webp'],
    ['Power Backups', 'UPS and power backup solutions to keep your work running.', 'product_ups.webp'],
    ['Printer Toner Cartridge', 'Genuine toner cartridges and printer consumables.', 'product_cartridge.webp'],
    ['Storage', 'Hard drives, SSDs and storage solutions for every need.', 'product_storage.webp'],
    ['Firewall', 'Network security appliances to protect your business.', 'product_firewall.webp'],
    ['Printers', 'Office and home printers from trusted brands.', 'product_printer.webp'],
    ['Laptops Bags', 'Protective laptop bags and carrying accessories.', 'product_bag.webp'],
    ['Servers', 'Scalable server hardware for growing organizations.', 'product_server.webp'],
    ['CCTV', 'Smart surveillance cameras and security systems.', 'product_cctv.webp'],
    ['Scanners', 'Fast, reliable document and image scanning solutions.', 'product_scanner.webp'],
    ['Laptop Battery', 'Replacement batteries for dependable laptop power.', 'product_battery.webp'],
];
?>
<!DOCTYPE html>
<html lang="en">
